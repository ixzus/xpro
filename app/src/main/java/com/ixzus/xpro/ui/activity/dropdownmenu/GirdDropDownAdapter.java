package com.ixzus.xpro.ui.activity.dropdownmenu;
...
public class GirdDropDownAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView != null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.x2item_list_drop_down, null);
    ...
    private void fillValue(int position, ViewHolder viewHolder) {
        ...
        if (checkItemPosition != -1) {
            if (checkItemPosition == position) {
                ...
                viewHolder.mText.setCompoundDrawablesWithIntrinsicBounds(null, null, context.getResources().getDrawable(R.mipmap.x2drop_down_checked), null);
            } else {
